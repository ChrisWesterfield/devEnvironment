...
PATH_SSL="/home/vagrant/base/etc/ssl"

# Path to the custom MjrOne $(hostname) Root CA certificate.
PATH_ROOT_CNF="${PATH_SSL}/vagrant.cnf"
PATH_ROOT_CRT="${PATH_SSL}/vagrant.crt"
PATH_ROOT_KEY="${PATH_SSL}/vagrant.key"

# Path to the custom site certificate.
CRT_PATH="/home/vagrant/base/etc/ssl/sites/${1}/"
PATH_CNF="${CRT_PATH}certificate.cnf"
PATH_CRT="${CRT_PATH}certificate.crt"
PATH_CSR="${CRT_PATH}certificate.csr"
PATH_KEY="${CRT_PATH}certificate.key"
...
then
    ...
    # Finally, generate the private key and certificate signed with the MjrOne $(hostname) Root CA.
