...
$output = sprintf('<table data-cpu="%s" id="process" class="table table-condensed table-bordered table-striped" style="%s">%s</table>', $cpu,'width: 100%!important;', $output);
                    ...
                    $(function () {
                        ...
                        $('#ref').on('click', function () {
                            ...
                            $.get('<?php echo $currentpath  ?>?ajax=1', function (h) {
                                ...
                                if (!stop) clv = setTimeout(function () {
                                    $('#ref').click();
                                }, 4000);
                            }, 'html');
                        });
